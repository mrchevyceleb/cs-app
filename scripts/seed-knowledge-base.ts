/**
 * Seed script to pre-populate the R-Link knowledge base with demo articles
 *
...
async function seedKnowledgeBase() {
  ...
  console.log(`Target: ${APP_URL}/api/knowledge\n`)
  ...
  for (const article of articles) {
    ...
    try {
      const response = await fetch(`${APP_URL}/api/knowledge`, {
        method: 'POST',
        headers: {
